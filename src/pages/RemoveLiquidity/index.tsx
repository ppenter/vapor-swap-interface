...
import { WTLOS } from 'constants/tokens'
...
export default function RemoveLiquidity({
      ...
      <>
        <RowBetween>
          <Text color={theme.text2} fontWeight={500} fontSize={16}>
            {'VAPOR ' + currencyA?.symbol + '/' + currencyB?.symbol} Burned
          </Text>
          <RowFixed>
  ...
  const oneCurrencyIsWETH = Boolean(
    chainId &&
      ((currencyA && currencyEquals(WTLOS[chainId], currencyA)) ||
        (currencyB && currencyEquals(WTLOS[chainId], currencyB)))
  )
      ...
      <AppBody>
        ...
        <Wrapper>
          ...
          <AutoColumn gap="md">
            <BlueCard>
              <AutoColumn gap="10px">
                <TYPE.link fontWeight={300} color={'secondary1'}>
                  ...
                  <AutoColumn gap="10px">
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/v2/${currencyA?.isNative ? WTLOS[chainId].address : currencyIdA}/${
                              currencyB?.isNative ? WTLOS[chainId].address : currencyIdB
                            }`}
                          >
                            Receive WTLOS
                          </StyledInternalLink>
                          ...
                          <StyledInternalLink
                            to={`/remove/v2/${
                              currencyA && currencyEquals(currencyA, WTLOS[chainId]) ? 'EVMOS' : currencyIdA
                            }/${currencyB && currencyEquals(currencyB, WTLOS[chainId]) ? 'EVMOS' : currencyIdB}`}
                          >
                            Receive EVMOS
                          </StyledInternalLink>
                        ) : null}
